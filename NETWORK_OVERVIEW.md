...
|-------|-----|-----|-----|----------|
| **Router** | 192.168.0.1 | - | Gateway | Internet-Gateway |
...
| **FOG Server** | 192.168.0.113 | - | LXC | PXE/Imaging |
...
| debian-vm | 100.64.0.6 | zabooz | Homepage Host |
...
192.168.0.200-250   - FOG DHCP (PXE Boot)
```
